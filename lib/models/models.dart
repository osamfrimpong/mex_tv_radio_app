...
import 'package:mextv_app/db/MyDbModel.dart';
...
//endregion CarouselimageManager
      ...
      */
      ...
      // end FIELDS
        ...
        Youtubevideo({this.id, this.thumbnail,this.video_url,this.video_id,this.video_title}) { setDefaultValues();}
        Youtubevideo.withFields(this.thumbnail,this.video_url,this.video_id,this.video_title){ setDefaultValues();}
        Youtubevideo.withId(this.id, this.thumbnail,this.video_url,this.video_id,this.video_title){ setDefaultValues();}
      
        // methods
        Map<String, dynamic> toMap({bool forQuery=false}) {
          var map = Map<String, dynamic>();
          if (id != null) map["id"] = id;    if (thumbnail != null) map["thumbnail"] = thumbnail;
    if (video_url != null) map["video_url"] = video_url;
    if (video_id != null) map["video_id"] = video_id;
    if (video_title != null) map["video_title"] = video_title;
    ...
    this.video_title = o["video_title"];

          }
      
        List<dynamic> toArgs() {
          return[id,thumbnail,video_url,video_id,video_title];   
        }  
        ...
        Future<int> save() async {
          if (id == null || id == 0)
            id = await _mnYoutubevideo.insert(
                Youtubevideo.withFields(thumbnail,video_url,video_id,video_title));
          else
            id= await _upsert();
          return id;
        }
        ...
        Future<List<BoolResult>> saveAll(List<Youtubevideo> youtubevideos) async {
          var results = _mnYoutubevideo.saveAll("INSERT OR REPLACE INTO youtubevideos (id, thumbnail,video_url,video_id,video_title)  VALUES (?,?,?,?,?)",youtubevideos);
          return results;
        }
        ...
        Future<int> _upsert() async {
          id = await _mnYoutubevideo.rawInsert(
              "INSERT OR REPLACE INTO youtubevideos (id, thumbnail,video_url,video_id,video_title)  VALUES (?,?,?,?,?)", [id,thumbnail,video_url,video_id,video_title]);
          return id;
        }
        ...
        Future<List<BoolResult>> upsertAll(List<Youtubevideo> youtubevideos) async {
          var results = await _mnYoutubevideo.rawInsertAll(
              "INSERT OR REPLACE INTO youtubevideos (id, thumbnail,video_url,video_id,video_title)  VALUES (?,?,?,?,?)", youtubevideos);
          return results;
        }
   ...
   class YoutubevideoFilterBuilder extends SearchCriteria {
     ...
     YoutubevideoField get id {
       ...
       return _id;
                ...
                YoutubevideoField _thumbnail;
     YoutubevideoField get thumbnail {
       _thumbnail = setField(_thumbnail, "thumbnail", DbType.text);
       return _thumbnail;
     }
     ...
     YoutubevideoField get video_url {
       ...
       return _video_url;
                ...
                YoutubevideoField _video_id;
     YoutubevideoField get video_id {
       _video_id = setField(_video_id, "video_id", DbType.text);
       return _video_id;
     }
                YoutubevideoField _video_title;
     YoutubevideoField get video_title {
       _video_title = setField(_video_title, "video_title", DbType.text);
       return _video_title;
     }
...
class YoutubevideoFields {
  ...
  static TableField get thumbnail {
    _fThumbnail = SqlSyntax.setField(_fThumbnail, "thumbnail", DbType.text);
    return _fThumbnail;
  }
  ...
  static TableField _fVideo_id;
  static TableField get video_id {
    _fVideo_id = SqlSyntax.setField(_fVideo_id, "video_id", DbType.text);
    return _fVideo_id;
  }
  static TableField _fVideo_title;
  static TableField get video_title {
    _fVideo_title = SqlSyntax.setField(_fVideo_title, "video_title", DbType.text);
    return _fVideo_title;
  }
